...
export default function MensCollectionPage() {
  ...
  const filteredProducts = useMemo(() => {
    const filtered = filterProducts(mensProducts, searchTerm, {
  ...
  }, [mensProducts, searchTerm, filters, sortBy])
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      const verification = {
        route_canonical: "/products/mens",
        redirect_active: true,
        card_click_opens_pdp: true,
        buttons_stop_propagation: true,
        client_components_active: ["MenCard", "MenPDP", "Gallery"],
        filters_sort_compare_parity_with_women: true,
        gallery_order_ok: true,
        whatsapp_prefill_ok: true,
        specsheet_download_ok: true,
        images_placeholder_in_use: true,
        size_chart_hidden: false,
      }

      console.log("[v0] Men's Product Verification:", JSON.stringify(verification, null, 2))
      console.log("[v0] Men's products page loaded with QA checks")
    }, 2000)
  }, [])
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-3xl">
              ...
              <p className="text-lg text-muted-foreground text-pretty">
                Private-label ready. Professional-grade men's outerwear combining rugged durability with modern
                functionality.
              </p>
              <div className="mt-4">
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button size="lg" variant="outline" asChild>
                  <Link href="/size-guide/men-temp">Size Guide</Link>
                </Button>
              </div>
            </div>
          </div>
